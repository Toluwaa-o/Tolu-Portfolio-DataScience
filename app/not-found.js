...
const NotFoundPage = () => {
  return (
    <div className="grid place-content-center bg-transparent h-[100vh] w-[100vw] absolute top-0 right-0 left-0">
      ...
      <h1 className="text-lg font-bold text-center">Oops, we couldn't find that page!</h1>
      <Link className="font-bold border-2 border-black px-4 py-2 rounded" href='/'>Go back home</Link>
    </div>
    </div>
  );
};
